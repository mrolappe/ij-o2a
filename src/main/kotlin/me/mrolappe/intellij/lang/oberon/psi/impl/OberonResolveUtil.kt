...
import me.mrolappe.intellij.lang.oberon.*
...
internal fun procedureParamOrNull(procedure: OberonProcedureDecl, paramName: String): OberonFormalParamName? {
    return PsiTreeUtil.findChildrenOfType(procedure, OberonFormalParamName::class.java)
        .firstOrNull { it.textMatches(paramName) }
}

internal fun receiverNameOrNull(procedure: OberonProcedureDecl, receiverName: String): OberonReceiverName? {
    return PsiTreeUtil.findChildOfType(procedure, OberonReceiverName::class.java)
...
fun OberonProcDeclName.procedureNameMatches(matchName: String) = this.procedureName.textMatches(matchName) ?: false
