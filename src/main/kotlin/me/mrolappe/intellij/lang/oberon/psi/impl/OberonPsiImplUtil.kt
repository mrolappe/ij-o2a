...
import me.mrolappe.intellij.lang.oberon.OberonIcons
...
//    fun getName(element: OberonProcedureDecl): String = "OberonPsiImplUtil.getName: ${element.node.findChildByType(OberonTypes.IDENT)?.text}"
    fun getName(element: OberonProcedureDecl): String = "${element.node.findChildByType(OberonTypes.IDENT)?.text}"
    ...
    @JvmStatic
    fun getNameIdentifier(element: OberonModuleDef): PsiElement? = element.node.findChildByType(OberonTypes.IDENT)?.psi
