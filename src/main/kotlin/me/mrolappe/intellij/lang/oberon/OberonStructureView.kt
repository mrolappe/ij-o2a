...
import me.mrolappe.intellij.lang.oberon.psi.impl.OberonModuleDefImpl
        ...
        return when (element) {
            ...
            is OberonModuleDef -> {
                ...
                val procedureDecls = PsiTreeUtil.getChildrenOfAnyType(element, OberonConstDeclName::class.java, OberonProcedureDecl::class.java,
                    OberonOberonAExternalProcDecl::class.java, OberonOberonALibProcDecl::class.java, OberonTypeDeclName::class.java)

                val constDeclNames = PsiTreeUtil.findChildrenOfType(element, OberonConstSection::class.java)
                    .flatMap { section -> PsiTreeUtil.collectElementsOfType(section, OberonConstDeclName::class.java) }

                val typeDeclNames = PsiTreeUtil.findChildrenOfType(element, OberonTypeSection::class.java)
