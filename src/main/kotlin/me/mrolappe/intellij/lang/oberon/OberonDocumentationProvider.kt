...
import me.mrolappe.intellij.autodocFunctionDescriptionOrNull
import me.mrolappe.intellij.lang.oberon.psi.OberonAmigaOberonSharedLibProcDecl
import me.mrolappe.intellij.lang.oberon.psi.OberonIdentDef
import me.mrolappe.intellij.lang.oberon.psi.OberonImportAlias
import me.mrolappe.intellij.lang.oberon.psi.OberonImportModuleReference
import me.mrolappe.intellij.lang.oberon.psi.OberonProcDeclName
...
class OberonDocumentationProvider : AbstractDocumentationProvider() {
    ...
    private fun autodocFunctionDescriptionByProcName(procName: String): String {
        val functionDescription = autodocFunctionDescriptionOrNull(procName)
