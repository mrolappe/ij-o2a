...
public class OberonFormalTypeImpl extends ASTWrapperPsiElement implements OberonFormalType {

  public OberonFormalTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitFormalType(this);
  }
