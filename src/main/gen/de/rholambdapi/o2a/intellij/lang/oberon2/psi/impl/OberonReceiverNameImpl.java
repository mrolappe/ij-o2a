...
public class OberonReceiverNameImpl extends OberonNamedElementImpl implements OberonReceiverName {

  public OberonReceiverNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitReceiverName(this);
  }
