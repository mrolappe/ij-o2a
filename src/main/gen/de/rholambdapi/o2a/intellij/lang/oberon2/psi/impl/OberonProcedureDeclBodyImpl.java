...
public class OberonProcedureDeclBodyImpl extends ASTWrapperPsiElement implements OberonProcedureDeclBody {

  public OberonProcedureDeclBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitProcedureDeclBody(this);
  }
