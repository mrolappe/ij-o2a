...
public class OberonSetLitImpl extends ASTWrapperPsiElement implements OberonSetLit {

  public OberonSetLitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitSetLit(this);
  }
  ...
  @Override
  @NotNull
  public List<OberonSetElem> getSetElemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonSetElem.class);
  }
