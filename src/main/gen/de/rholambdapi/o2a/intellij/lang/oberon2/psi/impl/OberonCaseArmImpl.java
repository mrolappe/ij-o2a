...
public class OberonCaseArmImpl extends ASTWrapperPsiElement implements OberonCaseArm {

  public OberonCaseArmImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public OberonCaseLabelList getCaseLabelList() {
    return findChildByClass(OberonCaseLabelList.class);
  }
