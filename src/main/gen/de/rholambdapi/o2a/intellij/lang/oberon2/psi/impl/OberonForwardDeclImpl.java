...
public class OberonForwardDeclImpl extends ASTWrapperPsiElement implements OberonForwardDecl {

  public OberonForwardDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public OberonIdentDef getIdentDef() {
    return findChildByClass(OberonIdentDef.class);
  }
