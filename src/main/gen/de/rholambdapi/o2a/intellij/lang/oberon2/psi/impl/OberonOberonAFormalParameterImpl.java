...
public class OberonOberonAFormalParameterImpl extends ASTWrapperPsiElement implements OberonOberonAFormalParameter {

  public OberonOberonAFormalParameterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitOberonAFormalParameter(this);
  }
