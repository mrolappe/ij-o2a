...
public class OberonImportModuleReferenceImpl extends ASTWrapperPsiElement implements OberonImportModuleReference {

  public OberonImportModuleReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitImportModuleReference(this);
  }
