...
public class OberonOberonAExternalProcDeclImpl extends ASTWrapperPsiElement implements OberonOberonAExternalProcDecl {

  public OberonOberonAExternalProcDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitOberonAExternalProcDecl(this);
  }
