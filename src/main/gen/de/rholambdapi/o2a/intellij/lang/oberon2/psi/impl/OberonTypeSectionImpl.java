...
public class OberonTypeSectionImpl extends ASTWrapperPsiElement implements OberonTypeSection {

  public OberonTypeSectionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<OberonTypeDecl> getTypeDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonTypeDecl.class);
  }
