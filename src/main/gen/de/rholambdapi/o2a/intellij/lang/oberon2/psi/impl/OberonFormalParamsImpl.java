...
public class OberonFormalParamsImpl extends ASTWrapperPsiElement implements OberonFormalParams {

  public OberonFormalParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<OberonFormalParamSection> getFormalParamSectionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonFormalParamSection.class);
  }
