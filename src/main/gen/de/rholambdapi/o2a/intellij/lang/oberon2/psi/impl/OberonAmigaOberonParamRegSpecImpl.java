...
public class OberonAmigaOberonParamRegSpecImpl extends ASTWrapperPsiElement implements OberonAmigaOberonParamRegSpec {

  public OberonAmigaOberonParamRegSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitAmigaOberonParamRegSpec(this);
  }
