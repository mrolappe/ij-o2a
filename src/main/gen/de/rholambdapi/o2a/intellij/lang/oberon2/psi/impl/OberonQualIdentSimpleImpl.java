...
public class OberonQualIdentSimpleImpl extends ASTWrapperPsiElement implements OberonQualIdentSimple {

  public OberonQualIdentSimpleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitQualIdentSimple(this);
  }
