...
public class OberonImportDeclsImpl extends ASTWrapperPsiElement implements OberonImportDecls {

  public OberonImportDeclsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitImportDecls(this);
  }
  ...
  @Override
  @NotNull
  public List<OberonImportDecl> getImportDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonImportDecl.class);
  }
