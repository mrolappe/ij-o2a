...
public class OberonActualParamsImpl extends ASTWrapperPsiElement implements OberonActualParams {

  public OberonActualParamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitActualParams(this);
  }
  ...
  @Override
  @Nullable
  public OberonExprList getExprList() {
    return findChildByClass(OberonExprList.class);
  }
