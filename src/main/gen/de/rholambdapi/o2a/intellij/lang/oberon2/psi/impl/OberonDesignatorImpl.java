...
public class OberonDesignatorImpl extends ASTWrapperPsiElement implements OberonDesignator {
  ...
  @Override
  @NotNull
  public List<OberonExprList> getExprListList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonExprList.class);
  }

  @Override
  @NotNull
  public List<OberonQualIdent> getQualIdentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonQualIdent.class);
  }
