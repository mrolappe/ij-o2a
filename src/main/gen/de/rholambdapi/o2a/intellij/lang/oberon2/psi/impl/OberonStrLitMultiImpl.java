...
public class OberonStrLitMultiImpl extends ASTWrapperPsiElement implements OberonStrLitMulti {

  public OberonStrLitMultiImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitStrLitMulti(this);
  }
