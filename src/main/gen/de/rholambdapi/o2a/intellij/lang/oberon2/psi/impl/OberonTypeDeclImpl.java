...
public class OberonTypeDeclImpl extends ASTWrapperPsiElement implements OberonTypeDecl {

  public OberonTypeDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public OberonTypeDeclName getTypeDeclName() {
    return findNotNullChildByClass(OberonTypeDeclName.class);
  }
