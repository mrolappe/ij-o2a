...
public class OberonRecordBaseTypeImpl extends ASTWrapperPsiElement implements OberonRecordBaseType {

  public OberonRecordBaseTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitRecordBaseType(this);
  }
