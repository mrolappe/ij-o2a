...
public class OberonElseBranchImpl extends ASTWrapperPsiElement implements OberonElseBranch {

  public OberonElseBranchImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public OberonStmtSeq getElseBlock() {
