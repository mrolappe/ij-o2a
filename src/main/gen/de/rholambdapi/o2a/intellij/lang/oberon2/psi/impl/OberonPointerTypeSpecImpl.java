...
public class OberonPointerTypeSpecImpl extends ASTWrapperPsiElement implements OberonPointerTypeSpec {

  public OberonPointerTypeSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitPointerTypeSpec(this);
  }
  ...
  @Override
  @Nullable
  public OberonRegSpec getRegSpec() {
    return findChildByClass(OberonRegSpec.class);
  }
