...
public class OberonSetElemImpl extends ASTWrapperPsiElement implements OberonSetElem {

  public OberonSetElemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitSetElem(this);
  }
