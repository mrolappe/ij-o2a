...
public class OberonProcDeclNameNoExpMarkImpl extends OberonProcDeclNameImpl implements OberonProcDeclNameNoExpMark {

  public OberonProcDeclNameNoExpMarkImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitProcDeclNameNoExpMark(this);
  }
