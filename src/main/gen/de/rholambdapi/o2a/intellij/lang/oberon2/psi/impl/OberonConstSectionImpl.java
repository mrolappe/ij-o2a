...
public class OberonConstSectionImpl extends ASTWrapperPsiElement implements OberonConstSection {

  public OberonConstSectionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<OberonConstDecl> getConstDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonConstDecl.class);
  }
