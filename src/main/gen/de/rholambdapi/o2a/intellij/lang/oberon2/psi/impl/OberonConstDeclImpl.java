...
public class OberonConstDeclImpl extends ASTWrapperPsiElement implements OberonConstDecl {

  public OberonConstDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public OberonConstDeclName getConstDeclName() {
    return findNotNullChildByClass(OberonConstDeclName.class);
  }

  @Override
  @NotNull
  public OberonConstExpr getConstExpr() {
    return findNotNullChildByClass(OberonConstExpr.class);
  }
