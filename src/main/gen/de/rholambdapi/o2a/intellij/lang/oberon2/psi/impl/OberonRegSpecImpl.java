...
public class OberonRegSpecImpl extends ASTWrapperPsiElement implements OberonRegSpec {

  public OberonRegSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitRegSpec(this);
  }
