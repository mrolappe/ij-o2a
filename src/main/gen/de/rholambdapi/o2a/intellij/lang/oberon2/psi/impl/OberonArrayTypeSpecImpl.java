...
public class OberonArrayTypeSpecImpl extends ASTWrapperPsiElement implements OberonArrayTypeSpec {

  public OberonArrayTypeSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitArrayTypeSpec(this);
  }
  ...
  @Override
  @NotNull
  public List<OberonConstExpr> getConstExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonConstExpr.class);
  }
