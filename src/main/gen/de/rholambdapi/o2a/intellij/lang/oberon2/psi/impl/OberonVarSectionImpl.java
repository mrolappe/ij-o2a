...
public class OberonVarSectionImpl extends ASTWrapperPsiElement implements OberonVarSection {

  public OberonVarSectionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<OberonVarDecl> getVarDeclList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonVarDecl.class);
  }
