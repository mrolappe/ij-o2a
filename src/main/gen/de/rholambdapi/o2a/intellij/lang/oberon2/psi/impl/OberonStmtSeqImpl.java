...
public class OberonStmtSeqImpl extends ASTWrapperPsiElement implements OberonStmtSeq {

  public OberonStmtSeqImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<OberonStmt> getStmtList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, OberonStmt.class);
  }
