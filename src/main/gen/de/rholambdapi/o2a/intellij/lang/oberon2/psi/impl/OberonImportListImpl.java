...
public class OberonImportListImpl extends ASTWrapperPsiElement implements OberonImportList {

  public OberonImportListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public OberonImportDecls getImportDecls() {
    return findChildByClass(OberonImportDecls.class);
  }
