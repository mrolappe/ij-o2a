...
public class OberonRecordTypeSpecImpl extends ASTWrapperPsiElement implements OberonRecordTypeSpec {

  public OberonRecordTypeSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitRecordTypeSpec(this);
  }
  ...
  @Override
  @Nullable
  public OberonRecordBaseType getRecordBaseType() {
    return findChildByClass(OberonRecordBaseType.class);
  }
