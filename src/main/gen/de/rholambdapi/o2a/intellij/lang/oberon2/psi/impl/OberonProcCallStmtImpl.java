...
public class OberonProcCallStmtImpl extends ASTWrapperPsiElement implements OberonProcCallStmt {

  public OberonProcCallStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitProcCallStmt(this);
  }
  ...
  @Override
  @NotNull
  public OberonDesignator getProcedureDesignator() {
