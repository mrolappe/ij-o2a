...
public class OberonModuleInitImpl extends ASTWrapperPsiElement implements OberonModuleInit {

  public OberonModuleInitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitModuleInit(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getBeginKeyword() {
