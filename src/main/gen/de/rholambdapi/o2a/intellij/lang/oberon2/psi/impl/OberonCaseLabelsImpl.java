...
public class OberonCaseLabelsImpl extends ASTWrapperPsiElement implements OberonCaseLabels {

  public OberonCaseLabelsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitCaseLabels(this);
  }
