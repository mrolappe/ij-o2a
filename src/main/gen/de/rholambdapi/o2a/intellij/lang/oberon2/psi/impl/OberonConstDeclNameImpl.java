...
public class OberonConstDeclNameImpl extends OberonNamedElementImpl implements OberonConstDeclName {

  public OberonConstDeclNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OberonVisitor visitor) {
    visitor.visitConstDeclName(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getConstantName() {
